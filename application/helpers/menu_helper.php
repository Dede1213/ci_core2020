...
function getMenu($id_user = false)
{
    ...
    if($query){
        ...
        foreach ($query as $data1) {
            ...
            if ($category_1) {
                #jika ada sub menu
                echo "<a href=".base_url($data1['link'])." class='nav-link'><i class='nav-icon ".$data1['icon']."'></i> <p>".$data1['menu']."</p><i class='fas fa-angle-left right'></i></a>";
                ...
                foreach ($category_1 as $data2) {
                    ...
                    if ($category_2) {
                        ...
                        echo"<a href=".base_url($data2['link'])." class='nav-link'><i class='nav-icon ".$data2['icon']."'></i> <p>".$data2['menu']."</p></a>";
                    }
                    echo"</li>";
                }
                ...
                #jika tidak ada sub menu
                echo "<a href=".base_url($data1['link'])." class='nav-link'><i class='nav-icon ".$data1['icon']."'></i> <p>".$data1['menu']."</p></a>";
